...
export const works: Work[] = [
  ...
  // ============================================================
  {
    ...
    summary:
      "3年半以上にわたり、WEB広告担当として広告運用に取り組みました。LINE広告・Meta広告・Google広告等の運用、広告CR制作、LP制作、求人広告の求人原稿および関連バナー制作、代理店のコントロールまで、広告集客に関わる業務を幅広く対応しました。",
    metrics: ["応募単価 5,000円", "採用単価 12,000円", "ROAS 4,500%"],
    scope: ["LINE広告運用", "Meta広告運用", "Google広告運用", "CR制作", "求人原稿制作", "LP制作", "代理店コントロール"],
  },
  {
    id: "crm-lstep",
    category: "crm",
