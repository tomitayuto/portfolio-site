...
export const works: Work[] = [
  ...
  },
  {
    ...
    summary:
      "派遣業界特有の競合の激しさを踏まえ、応募者を離脱させない仕組み作りに取り組みました。ATSツール「RPM」を活用し、面接日程調整やメッセージ送信の自動化、応募者リストを既存資産として活かす運用設計、電話対応漏れを検知するアラート実装まで、幅広く対応しています。",
    metrics: ["週明けの面接設定率 50%UP", "面接予約数 40%UP"],
    scope: ["ATS（RPM）", "自動化設計", "応募者管理", "業務効率化"],
  },
  {
    id: "pm-staffing",
    category: "pm",
    ...
    summary:
      "ペルソナ設計から集客戦略・集客スキームの根本的な見直しまで、上流から事業の意思決定に並走しています。",
